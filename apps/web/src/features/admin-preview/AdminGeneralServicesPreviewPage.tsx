...
import { 
  Globe2, ArrowLeft, ArrowRight, Search, Filter, Plus, 
...
export function AdminGeneralServicesPreviewPage() {
  ...
  const [newService, setNewService] = useState({
    ...
    excludedScope: '',
    userRequirements: '',
    slaDeliveryTime: '2 Business Days',
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const data = await ApiClient.getAdminGeneralServices();
      setServices(data);
    } catch {
      // Fallback sample dataset for General Support Services
      setServices([
        {
          id: 'gen_srv_01',
          ...
          status: 'PUBLISHED',
          assignedTeam: 'فريق الترجمة المعتمدة',
        ...
        {
          id: 'gen_srv_02',
          titleAr: 'تنسيق وإدارة تصديق الشهادات لدى الجهات والوزارات المختصة',
          titleEn: 'Degree Attestation & Notarization Coordination',
          category: 'DOCUMENT_ATTESTATION',
          categoryLabelAr: 'تصديق الأوراق والشهادات',
          priceType: 'TIERED_PACKAGE',
          priceFormatted: 'يبدأ من $89 (حسب البلد)',
          slaDeliveryTime: '5-7 أيام عمل',
          status: 'PUBLISHED',
          assignedTeam: 'قسم العلاقات والدعم القنصلي',
          activeRequestsCount: 22,
          hasTemplates: true,
          updatedAt: '2026-07-26 12:00'
        },
        {
          id: 'gen_srv_03',
          titleAr: 'تنسيق واستخراج ملف طلب التأشيرة الدراسية وحجز مواعيد السفارة',
          titleEn: 'Student Visa File Prep & Embassy Appointment Booking',
          category: 'VISA_TRAVEL_SUPPORT',
          categoryLabelAr: 'تأشيرات ودعم السفر',
          priceType: 'PAID_FIXED',
          priceFormatted: '$149',
          slaDeliveryTime: '3 أيام عمل',
          status: 'PUBLISHED',
          assignedTeam: 'وحدة دعم التأشيرات',
          activeRequestsCount: 18,
          hasTemplates: true,
          updatedAt: '2026-07-25 14:20'
        },
        {
          id: 'gen_srv_04',
          titleAr: 'تجهيز وتنسيق استمارات ونماذج التقديم الرسمية والمصادقات',
          titleEn: 'Official Form & Application Template Preparation',
          category: 'FORM_PREPARATION',
          categoryLabelAr: 'تجهيز الاستمارات والنماذج',
          priceType: 'FREE',
          priceFormatted: 'خدمة مجانية',
          slaDeliveryTime: '24 ساعة',
          status: 'READY_TO_PUBLISH',
          assignedTeam: 'فريق الدعم التشغيلي',
        ...
        {
          id: 'gen_srv_05',
          titleAr: 'مساندة واستشارات السكن الطلابي والاستقبال في بلد الدراسة',
          titleEn: 'Student Housing & Airport Greeting Coordination',
          category: 'OPERATIONAL_ASSISTANCE',
          categoryLabelAr: 'المساندة التشغيلية والسكن',
          priceType: 'MISSING_PRICE',
          priceFormatted: 'لم يتم تحديد الباقة',
          slaDeliveryTime: 'حسب الطلب',
          status: 'DRAFT',
          assignedTeam: 'شبكة المنسقين المحليين',
  ...
  const handleCreateService = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await ApiClient.createAdminGeneralService(newService);
    } catch {
      // Add locally for prototype preview
      const created = {
        id: `gen_srv_${Date.now()}`,
        titleAr: newService.titleAr || 'خدمة عامة جديدة',
        titleEn: newService.titleEn || 'New General Service',
        category: newService.category,
        categoryLabelAr: 'خدمة عامة',
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 dir-rtl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 dark:border-gray-800 pb-5">
        <div>
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-1">
            ...
            <span>/</span>
            <span className="text-blue-600 font-medium">الخدمات العامة والدعم</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
            <Globe2 className="w-7 h-7 text-blue-600" />
            إدارة الخدمات العامة والدعم (General Support Services)
          </h1>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            إدارة خدمات الترجمة المعتمدة، تصديق الشهادات والأوراق، مساندة التأشيرات، وتجهيز الاستمارات والوثائق.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium flex items-center gap-2 text-sm transition-colors shadow-sm"
          >
            <Plus className="w-4 h-4" />
            <span>إضافة خدمة عامة</span>
          </button>
        </div>
      </div>
      ...
      <div className="p-3.5 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/50 flex items-center gap-3 text-xs text-amber-900 dark:text-amber-300">
        ...
        <span>الخدمات العامة عروض غير تعليمية ضمن Phase 20. الدورات والمساقات المأجورة تبقى ضمن Phase 13، وتطبيق عمليات الدفع يدار عبر Phase 19.</span>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-3 items-center justify-between">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              placeholder="البحث باسم الخدمة العامة أو الوصف..."
              className="w-full pr-9 pl-4 py-2 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            ...
            >
              <option value="ALL">جميع أنواع الخدمات العامة</option>
              <option value="DOCUMENT_TRANSLATION">ترجمة المستندات المعتمدة</option>
              <option value="DOCUMENT_ATTESTATION">تصديق الأوراق والشهادات</option>
              <option value="VISA_TRAVEL_SUPPORT">تأشيرات ودعم السفر</option>
              <option value="FORM_PREPARATION">تجهيز الاستمارات والنماذج</option>
              <option value="OPERATIONAL_ASSISTANCE">المساندة التشغيلية والدعم</option>
            </select>
            ...
            <button
              onClick={loadData}
              className="p-2 text-gray-500 hover:text-blue-600 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-800"
              title="تحديث القائمة"
            >
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm">
        {loading ? (
          <div className="p-12 text-center text-gray-500">جاري تحميل الخدمات العامة...</div>
        ) : filteredServices.length === 0 ? (
          <div className="p-12 text-center text-gray-500">لا توجد خدمات عامة مطابقة للبحث أو الفلاتر.</div>
        ) : (
              ...
              <div key={srv.id} className="p-4 hover:bg-gray-50/80 dark:hover:bg-gray-800/40 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1.5 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                      {srv.categoryLabelAr}
                    </span>
                  </div>
                  {srv.titleEn && (
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <button
                    onClick={() => navigate(`/admin/services/general/${srv.id}`)}
                    className="px-3.5 py-1.5 rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-blue-50 dark:hover:bg-blue-950/40 hover:text-blue-600 text-xs font-medium transition-colors flex items-center gap-1.5"
                  >
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl max-w-2xl w-full p-6 space-y-6 max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-4">
              <h2 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                إضافة خدمة عامة جديدة (General Support Service)
              </h2>
            ...
            <form onSubmit={handleCreateService} className="space-y-4 text-sm">
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: خدمة الترجمة المعتمدة للوثائق الأكاديمية"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Certified Document Translation Service"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="وصف لمجال الخدمة العامة ومخرجات العمل..."
                  className="w-full px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:outline-none"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="ختم المترجم المعتمد، إرسال نسخة إلكترونية وورقية..."
                    className="w-full px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:outline-none"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="رسوم الشحن الدولي السريع، رسوم سفارة..."
                    className="w-full px-3 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:outline-none"
                  />
                </div>
              </div>
